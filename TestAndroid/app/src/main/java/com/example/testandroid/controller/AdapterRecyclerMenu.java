...
import com.example.testandroid.model.Menu;

import java.util.ArrayList;

public class AdapterRecyclerMenu extends RecyclerView.Adapter<AdapterRecyclerMenu.ViewHolder> {
    private ArrayList<Menu> modelMenus;
    public AdapterRecyclerMenu(ArrayList<Menu> modelMenus) {
    ...
    public void updateData(ArrayList<Menu> listNonCoffe) {
